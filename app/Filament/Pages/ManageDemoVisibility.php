        ...
        return $schema
            ->components([
                Section::make('Показ демо-данных')
                    ->description(
                        'Данные из DemoSeeder (лоты демо-продавцов, категория «Демо-кейсы», сделки с демолотами). При выключении они скрыты на сайте (API и SPA) и в списках этой админки. Удаление из БД — команда php artisan demo:wipe.',
                    )
                    ->schema([
